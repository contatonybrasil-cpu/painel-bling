...
app.get('/api/pedidos', ensureToken, async (req, res) => {
  try {
    ...
    // Full ML: pedidos do ML com unidadeNegocio = 2285546 (Mercado Livre Full)
    const isFullML = o => Number(o.loja && o.loja.unidadeNegocio && o.loja.unidadeNegocio.id) === 2285546;
